        ...
        <form action=" " method="post">
            <div class="centre">
                ...
                if (isset($_POST['name'])){
                    ...
                    $sql="DELETE FROM `project`.`member` WHERE id=$idupdate;";
                    if($conn->query($sql) == true){
                    ?><script>alert("Deleted successfully");</script><?php
                }
                else{
                    ?><script>alert("Data is not deleted");</script><?php
                }
                }
                ?>
                <div class="textbox">
                ...
                <div class="textbox">
                    <input type="tel" placeholder="Mobile Number" name="mbno" value="<?php echo $arrdata['mbno']; ?>" maxlength="10" />
                </div>
                <div class="textbox">
